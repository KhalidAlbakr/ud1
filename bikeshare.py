...
def get_filters():
    ...
    """
    print('Hello! Let\'s explore some US bikeshare data! r/dataisbeautiful Also check out r/meme')
    # get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs
    city = input("Please input city name: Chicago / New York City / Washington? ").lower()

    while city not in ['chicago', 'new york city', 'washington']:
        city = input(
        "City is name is invalid! Please input another name: Chicago or New York City or Washington ").lower()

    # get user input for month (all, january, february, ... , june)
    month = input("Please input month name: January, February, March, April, May, June, or all? ").lower()

    # get user input for day of week (all, monday, tuesday, ... sunday)
    day = input("Please input day of week: Sunday, Monday, or all? ").lower()
...
def main():
    ...
    while True:
        ...
        restart = input('\nWould you like to restart? Enter yes or type anything to exit the program.\n')
